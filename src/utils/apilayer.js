...
export async function getUsdToArs() {
  ...
  try {
    ...
    console.error('getUsdToArs failed:', e);
    throw e;
  }
}
...
export async function validatePhone(number, countryCode = "AR") {
  ...
  try {
    ...
    console.warn('validatePhone network error:', e);
    return null;
  }
}
...
export async function validateEmail(email) {
  ...
  try {
    ...
    console.warn('validateEmail network error:', e);
    return null;
  }
}
...
export async function getVatRate(countryCode = "AR") {
  ...
  try {
    ...
    console.warn('getVatRate network error:', e);
    return null;
  }
}
